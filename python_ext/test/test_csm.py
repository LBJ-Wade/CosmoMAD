...
pcsp=csm.PcsPar()
pcsp.background_set(0.315,0.685,0.049,-1,0,0.67,2.725);
pcsp.set_linear_pk("EH",-3,3,0.01,0.95,0.8)
xi_arr=np.array([pcsp.xi2p_L(r,2,2,"Gauss","Gauss") for r in r_arr])
